...
//           >
//             <motion.h1
//               className="text-5xl md:text-6xl font-extrabold leading-tight text-gray-800 justify-center"
//               initial={{ y: 20, opacity: 0 }}
//               animate={{ y: 0, opacity: 1 }}
...
//             >
//               <Button
//                 className="bg-blue-600 hover:bg-purple-700 transition duration-300 text-white px-6 py-3 rounded-2xl w-[200px] h-[50px]"
